...
const GeneratedServices = {
  AlarmClockService: require('./services/alarm-clock.service'),
  AVTransportService: require('./services/av-transport.service'),
  ContentDirectoryService: require('./services/content-directory.service'),
  DevicePropertiesService: require('./services/device-properties.service'),
  RenderingControlService: require('./services/rendering-control.service'),
  SystemPropertiesService: require('./services/system-properties.service'),
  ZoneGroupTopologyService: require('./services/zone-group-topology.service')
}
...
/**
 * Generated AlarmClockService
 */
Sonos.prototype.AlarmClockService = function () {
  return new GeneratedServices.AlarmClockService(this.host, this.port)
}

/**
 * Generated AVTransportService
 */
Sonos.prototype.AVTransportService = function () {
  return new GeneratedServices.AVTransportService(this.host, this.port)
}

/**
 * Generated ContentDirectoryService
 */
Sonos.prototype.ContentDirectoryService = function () {
  return new GeneratedServices.ContentDirectoryService(this.host, this.port)
}

/**
 * Generated DevicePropertiesService
 */
Sonos.prototype.DevicePropertiesService = function () {
  return new GeneratedServices.DevicePropertiesService(this.host, this.port)
}

/**
 * Generated RenderingControlService
 */
Sonos.prototype.RenderingControlService = function () {
  return new GeneratedServices.RenderingControlService(this.host, this.port)
}

/**
 * Generated SystemPropertiesService
 */
Sonos.prototype.SystemPropertiesService = function () {
  return new GeneratedServices.SystemPropertiesService(this.host, this.port)
}

/**
 * Generated ZoneGroupTopologyService
 */
Sonos.prototype.ZoneGroupTopologyService = function () {
  return new GeneratedServices.ZoneGroupTopologyService(this.host, this.port)
}
