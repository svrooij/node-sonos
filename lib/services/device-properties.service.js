...
class DevicePropertiesService extends Service {
  ...
  /**
   * CreateStereoPair - Create a stereo pair (left, right speakers), right one becomes hidden - only supported by some players
   *
   * @param {Object} [options] - An object with the following properties
  ...
  /**
   * SeparateStereoPair - Separate a stereo pair - only supported by some players
   *
   * @param {Object} [options] - An object with the following properties
   * @param {string} options.ChannelMapSet - example: RINCON_B8E9375831C001400:LF,LF;RINCON_000E58FE3AEA01400:RF,RF
   */
